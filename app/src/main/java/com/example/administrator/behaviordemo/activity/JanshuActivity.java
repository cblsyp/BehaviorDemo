...
import com.example.administrator.behaviordemo.activity.entry.JsEntry;
 ...
 * 经过整理后的更加容易理解  初步感觉 貌似没有对AppbarLayout  进行更多的处理
 * 没有什么其他的处理 就是增加了一个控件的使用  但是这个AppBarLayout 的具体实现还是没有搞清楚
 */
...
public class JanshuActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mAppBarLayout = (AppBarLayout) findViewById(R.id.janshu_activity_layout);
        mLine = findViewById(R.id.line_divider);
        mConvenientBanner = (ConvenientBanner) findViewById(R.id.banner);
        mRecyclerView = (RecyclerView) findViewById(R.id.vertical_recycleView);
    ...
    public static class MyAdapter extends RecyclerView.Adapter {
        ...
        public void setmData(List<JsEntry> mData) {
            this.mData = mData;
        }

        /**
         * LayoutInflater 其中加载的布局,就是一个view
         *
         * @param parent
         * @param viewType
         * @return
